...
class TestOperator(PymatgenTest):
    ...
    def testSingularOperators(self):
        ...
        self.assertTrue(pow2.is_singular)
        ...
        self.assertTrue(pow3.is_singular)
        ...
        self.assertTrue(sqrt.is_singular)
    ...
    def testBinaryOperators(self):
        ...
        self.assertFalse(add.is_singular)
        ...
        self.assertFalse(sub.is_singular)
...
class TestFeatureGenerator(PymatgenTest):
    ...
    def testFeatureGenerator(self):
        ops = ['^2', '+', '-']
        nf_df = features_generator(self.df, ops)
