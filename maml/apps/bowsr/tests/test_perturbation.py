...
class WyckoffPerturbationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        lfpo_symm_ops = [SymmOp.from_rotation_and_translation(rotation, translation, tol=0.1) \
        ...
        lco_symm_ops = [SymmOp.from_rotation_and_translation(rotation, translation, tol=0.1) \
    ...
    def test_standardize(self):
        ...
        for site in self.test_lfpo[20:]:
            np.testing.assert_array_almost_equal(self.wp3.standardize(site.frac_coords),
                                                 site.frac_coords)
