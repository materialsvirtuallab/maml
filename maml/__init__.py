...
class Describer(BaseEstimator, MSONable, TransformerMixin):
    ...
    def describe(self, obj):
        ...
        Returns:
            Descriptor for a structure. Recommended format is a pandas
    ...
    def describe_all(self, objs):
        ...
        Returns:
            Concatenated descriptors for all objects. Recommended format
...
class Model(BaseEstimator, MSONable):
    ...
    def evaluate(self, features, targets, metrics=['mae'], multi_targets=False):
        ...
        Args:
            features (list or np.ndarray): feature vectors or tensors
            targets (list of np.ndarray): target vectors or tensors
            metrics (list of string or callable): evaluation metrics
            multi_targets (bool): whether multiple targets are present

        Returns:
            dict of metric evaluations
        """
