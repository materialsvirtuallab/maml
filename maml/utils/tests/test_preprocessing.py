...
class TestPreprocessing(unittest.TestCase):
    def test_ss(self):
        ...
        s = Structure(Lattice.cubic(3.16), ['Mo', 'Mo'],
                      [[0, 0, 0], [0.5, 0.5, 0.5]])

        ss2 = StandardScaler.from_training_data(structures=[s, s],
                                                targets=[0, 0],
                                                is_intensive=True)
    ...
    def test_dummy(self):
        ...
        self.assertAlmostEqual(DummyScaler.from_training_data([0, 0], [0, 0]).inverse_transform(100),
                               100)
